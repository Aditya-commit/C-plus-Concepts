...
// VECTORS ARE BASICALLY ARRAYS WITH TEMPLATE FEATURE
...
int main(){
    ...
    // THE CAPACITY OR THE MEMORY WILL ALWAYS BE GREATER THAN THE ONE WE ARE ACTUALLY USING TO SUPPORT FUTURE GROWTH (IF WE WANT WE CAN RETURN THE EXTRA MEMEORY TO THE SYSTEM USING shrink_to_fit() METHOD)

    cout << "Capacity of v2 = " << v2.capacity() << endl;
    cout << "Size of v2 = " << sizeof(v2) << endl;
    
    
    // RETURN EXTRA MEMORY TO THE SYSTEM (THE COMPILER COULD ALSO IGNORE THE REQUEST) , USED MOSTLY AFTER REMOVING ELEMENTS FROM THE VECTOR , NOT LIKE THIS
    v2.shrink_to_fit();
